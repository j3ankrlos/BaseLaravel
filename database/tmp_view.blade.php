        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg modal-premium">
                <div class="modal-header bg-white border-0 pt-4 px-4 pb-0 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0 text-dark" id="batchFormModalLabel">{{ $batchId ? 'EDITAR' : 'NUEVO' }} LOTE DE IMPORTACIÓN</h5>
                        <p class="text-muted small mb-0">Registre los datos maestros del cargamento que llega a la granja.</p>
                    </div>
